    ...
    def Update_Hidden_Or_Motor_Neuron(self, neurons, synapses):
        ...
        for key in synapses:
            ...
            if key[1] == self.Get_Name():
                ...
                name=key[0]
                # print('original neruon value: ', self.Get_Value())
                self.Allow_Presynaptic_Neuron_To_Influence_Me(weight, neurons[name].Get_Value())
                # print('new neuron value: ', self.Get_Value())
                # print('weight: ', weight, 'value: ',neurons[name].Get_Value())
        self.Threshold()

    def Allow_Presynaptic_Neuron_To_Influence_Me(self,weight, name):
        result=weight*name
